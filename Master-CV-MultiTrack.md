...
Nairobi, Kenya | brianlembuss@gmail.com | +254 705 875103
[LinkedIn Profile](https://www.linkedin.com/in/brian-kipchumba-lembuss-kirwa/) | [GitHub / Portfolio](https://github.com/lembuss/)
...
**Venture Building & Entrepreneurial Leadership:** Technical venture creation; company incorporation; corporate governance; Cap Table structuring; fundraising; SAFE financing; grant acquisition; commercial partnerships; MoU negotiation; accelerator programmes; market discovery; product development; technical leadership; recruitment.

**Deep-Tech Research & Computational Capability:** Applied aerospace research; computational modelling; UAM simulation; aerodynamic CFD; embedded C++; test-driven development; autonomous systems; ROS; 3D perception; MBSE; AI/ML; cloud systems; data pipelines; photogrammetry; OpenFOAM; ANSYS CFX; MATLAB; Python; C++; TypeScript/Node.js/React.

**Teaching, Mentorship & Academic Service:** University instruction; flight simulator instruction; examining; numerical methods; SI-PASS tutoring; STEM mentorship; curriculum support; academic administration; student organisation leadership.

---

## PROFESSIONAL EXPERIENCE & SELECTED R&D PROJECTS

### Founding CEO & Lead Systems Engineer
**Kipepeo Aerospace** | Startup | Nairobi, Kenya | Oct 2024 – Present
*Founding CEO and Lead Systems Engineer driving the full-stack design, hardware fabrication, software architecture, and commercial strategy for autonomous UAV platforms, multispectral payload hardware, cloud photogrammetry pipelines, and AI intelligence systems across precision agriculture and defense verticals.*
...
**AngaStack V1 Platform Development (R&D)**
* Local Photogrammetry Pipeline Development & Algorithm Verification: Developed and verified a local Python photogrammetry engine capable of reliably stitching raw drone imagery into orthomosaics and producing vegetation index rasters.
* Full-Stack Application Development (AngaView UI & AngaCloud Backend): Functional, integrated full-stack web application and REST API orchestrator capable of managing farm data, handling image uploads, and communicating locally with the processing pipeline.
* Azure Cloud Infrastructure Provisioning & Live Platform Deployment: Production-grade, automated cloud infrastructure on Azure capable of ephemeral batch processing and live web deployment.
* AngaDemo Digital Prototype Build & Field Usability Validation: Validated high farmer demand (93.9% stated interest), established a 325.56 KES/acre willingness-to-pay baseline, and identified critical UI/UX iterations that directly shaped the AngaStack V2 redesign.
...
**AngaStack V2 Platform Development - GCP Cloud Migration, Mobile Ingestion & AngAi Engine (R&D)**
* GCP Infrastructure Provisioning & IAM Security Architecture: Production-grade GCP cloud infrastructure (europe-west1) establishing storage buckets, document database, container registry, authentication provider, and IAM security controls.
* Photogrammetry Pipeline GCP Migration & Numerical Stats Extraction: Ephemeral, stateless batch-processing engine running on GCP Cloud Run Jobs that ingests raw drone imagery from GCS, generates orthomosaics/index maps, and writes numerical stats JSON directly to Firestore.
* Backend Service Refactoring, Dual-Path Ingestion & Job Orchestration: Operational FastAPI backend service on GCP Cloud Run handling multi-source observation ingestion, GCS Signed URL map rendering, and Firebase token authentication.
* AngAi Agronomic Reasoning Engine & RAG Microservice Build: Operational, authenticated RAG microservice on GCP Cloud Run capable of processing multi-source observation payloads and generating context-aware agronomic Action Cards in Firestore.
* AngaView Mobile Ingestion, Firebase Hosting & Living Farm Health Record UI: Deployed, mobile-responsive web and Android application on Firebase Hosting featuring instant mobile photo diagnostics, interactive GCS-signed raster map rendering, and a unified longitudinal farm health record.
...
* Formulated the foundational vision, operational roadmap, and financial budget for establishing an indigenous drone technology hub at Konza Technopolis.
* Executed formal business name registration and statutory setup to legally establish Kipepeo Aerospace in Nairobi, Kenya.
* Applied for and secured non-dilutive cloud infrastructure grant funding through the Microsoft for Startups Founders Hub program and Google Cloud for Startups program.
* Negotiated and executed three strategic Memorandums of Understanding (MoUs) with Stablegen Investment Ltd.
* Registered core internet domains, established digital brand presence, and deployed web infrastructure for Kipepeo Aerospace and its flagship initiative Kilimo Anga.
* Conducted talent acquisition campaigns, restructured executive roles, and established a specialized advisory board.
* Applied for the MK-Africa #MyLittleBigThing Sustainable Venture Challenge with Kilimo Anga, securing selection into the Top 50 and completing the two-day Innovation Bootcamp and the 30-Day Build & Test Challenge.
* Completed the Viktoria Ventures Startup360 Access to Finance (A2F) Programme and authored the $30,000 pre-seed investor readiness dossier and financial model for Kilimo Anga.
* Authored and executed the binding Kipepeo Aerospace Pre-Incorporation Founders' Agreement, establishing legal governance, cap table ownership, reverse vesting, and operational decision hierarchies under Kenyan law.
* Negotiated and executed the first formal early-stage investment agreement for Kipepeo Aerospace via a Simple Agreement for Future Equity (SAFE) with Zimbu Investments Limited ($1,000 investment at $1,000,000 valuation cap).
* Applied for and onboarded into the 12-Month #MyLittleBigThing Investor Readiness Program (IRP) Pilot Cohort (2026–2027).

### Jasiri Fellow, Talent Investor Program
**Jasiri4Africa** | Rwanda / Remote | Jan 2025 – May 2025
* Completed the Jasiri Jumpstart and 3-month Residential Intensive while executing field-level market discovery on smallholder agri-data adoption barriers in Kenya.
* Formulated the dual-sided business model canvas and revenue architecture for the iCARUS precision agriculture concept.
* Authored and delivered the iCARUS venture pitch deck at Jasiri Demo Day 1 in Bugesera, Rwanda.

### Aerospace Systems Engineering (Working Student)
**Amazilia Aerospace GmbH** | Munich, Germany | Sep 2022 – Dec 2024
...
### Project Manager - Systems Integration & Flight Testing
**HORYZN (TU Munich Student Aerospace Initiative)** | Munich, Germany | Jul 2023 – Jul 2024
...
**HORYZN (TU Munich Student Aerospace Initiative)** | Munich, Germany | Oct 2022 – Jun 2023
...
### UAS Engineer, Pilot and Instructor
**Kendrone Ltd** | Mtwapa, Nairobi, Naivasha | Jan 2021 – Jun 2021
...
* Delivered a 32-slide technical presentation on BVLOS UAS operations to Kendrone leadership contributing to the Instructor Rating requirements.
* Delivered full KCAA RPL ground school theory programme across three student cohorts covering seven subject domains (100% pass rate).
* Delivered 15-lesson KCAA RPL practical flight instruction programme across three student cohorts on multirotor platforms (9.0 logged instructor flight hours).
...
* Diagnosed and resolved company email deliverability failures (SPF/DKIM/DMARC) and optimised web infrastructure.
* Reorganised company and student databases and maintained operational records.
* Designed company marketing collateral (brochures, business cards, 3D printed placards) and managed digital marketing channels.
* Led external stakeholder engagement across regulatory bodies, media, landowners, aviation doctors, and commercial clients.

### Aircraft Maintenance Intern
**ALS Ltd** | Nairobi, Kenya | Jul 2017 – Sep 2017
* Aircraft Line, Base & C-Check Maintenance: Assisted with fuel nozzle replacement, compressor wash, and propeller shaft greasing on the PT6A-65B turboprop engine (Beechcraft 1900C 200HR inspection).
...
**M.Sc. Research (Technical University of Munich)**
* **Generic Modeling of Slotneutral UAM Throughput at Commercial Airports (R&D):** Processed 24-hour Flightradar24 traffic data (Munich Airport) showing 86.9% of arriving traffic falls into CAT-D/E. Formulated IFR PinS approach procedures allowing eVTOLs to transition without crossing active runways. Delivered a Python toolchain generating 3D KML trajectories, reducing approach detours from 66 km to ~15 km. Co-authored the resulting paper presented at AIAA 2024.
* **Autonomous Sub-Terrain UAV Challenge (R&D):** Engineered a depth-to-pointcloud perception engine and an OctoMap 3D voxel grid mapping pipeline in ROS/C++ for a simulated sub-terrain quadrotor executing fully autonomous cave transit and object localization.
* **Embedded Software Development of the Actuator Control and Monitoring Unit (ACMU) (R&D):** Refactored the embedded C++ data logging software pipeline for an aircraft ACMU using TDD. Implemented high-efficiency binary serialization over USB, achieving an 80% reduction in frame size (100 to 20 bytes).
* **Applied CFD Channel & Cavity Flow Simulation (R&D):** Executed 5 comparative CFD simulations in ANSYS CFX, demonstrating that SSG Reynolds Stress Models accurately capture flow separation and cavity recirculation where SST failed.
* **Simulation of the Flowfield of a Multirotor in Axial Flight (R&D):** Modelled 3D flow fields of a quadrotor in axial descent using OpenFOAM, computing rotor thrust/torque via Blade Element Momentum Theory (BEMT) actuator disk source terms.
* **Geospatial Analysis & Cartography - Nakuru County Geotourism Research (R&D):** Processed spatial datasets and generated all cartographic figures and geological mapping overlays using QGIS for a peer-reviewed research publication.

**B.Sc. Capstone & Coursework (Middle East Technical University)**
* **Conceptual Design of a Fixed-Wing Luxury Aircraft (Capstone I):** Delivered a fully sized conceptual design (W0 = 20,600 kg) validated against performance constraints, with 1:150 scale 3-view CAD layouts.
* **Conceptual Design of a VTOL Personal Air Vehicle (Capstone II):** Sized a light civil rotorcraft (TOGW = 2,014 kg) using BEMT, completing forward flight power analysis and generating a full configuration design.
* **Numerical Methods Solvers:** Developed FORTRAN solvers for finite volume potential flow and FDM heat/convection-diffusion. Developed MATLAB FDM solvers for aerodynamic PDEs (Lax-Wendroff, MacCormack).
* **FEA of Composite Cantilever Beam:** Conducted static structural and torsional FEA in ANSYS Mechanical APDL, extracting modal frequencies and harmonic responses.
* **Simulation of a piezoelectric d15 torsion sensor (R&D):** Modelled a PIC255 piezoceramic sensor in Abaqus CAE to compute electromechanical coupling coefficients.
* **Automated Air Filter:** Designed, built, and tested an autonomous Arduino-based air filtration system detecting dust/smoke density.
* **Turbofan Compressor Performance Analysis (R&D):** Conducted parametric analysis of compressor performance via MATLAB.

**LEAD! Leadership for Africa (University of Cologne)**
* **MBSE Agricultural UAS Architecture (R&D):** Developed a comprehensive MBSE-structured UAS architecture for precision agriculture at the Galana Kulalu Irrigation Scheme, complete with payload definitions, WBS, and SWOT/PEST analyses. Graded *Sehr gut* (A).

**eMobilis Technology Institute**
* **Fadhili - Android Carpool Application:** Designed and developed an end-to-end full-stack Android carpool application in Kotlin/Java with Firebase authentication and GeoFire real-time location. Co-founded the Coding Collective peer group.
...
*M.Sc. Aerospace Engineering* | Oct 2021 – Present
* **Status:** Degree completion pending (73 ECTS completed; 17 credits and thesis remaining).
* **Focus:** Aircraft Systems, Control, and UAS Integration.

**University of Cologne** | Cologne, Germany
*LEAD! Leadership for Africa (DAAD Scholar)* | Feb 2022 – Jan 2023
* **Details:** 260 units / 195 hours. Grade: *Sehr gut* (A), 8 ECTS.

**Middle East Technical University (METU)** | Northern Cyprus Campus
*B.Sc. Aerospace Engineering* | Sep 2015 – Jun 2019
* **Graduation Honors:** Şeref / Honour Classification (CGPA: 3.12/4.00, 259.5 ECTS).
...
* **Co-Author**, *"Geotourism Potential of Geological Resources in Selected Regions of Nakuru County, along the Gregory Rift, Kenya"* - Peer-reviewed journal article.

---

## TEACHING, MENTORSHIP & ACADEMIC EXPERIENCE

**Student Assistant - IFR Simulator Instructor & Examiner** | TUM Institute for Rotorcraft and Vertical Flight | Apr 2023 – Sep 2024
* Instructed student cohorts across three semesters (8 weekly 5-hour sessions) in practical helicopter IFR operations on an EC135 fixed-base flight simulator. Served as official course examiner for 5-hour final oral and practical examinations.

**Student Assistant - ASE301 Numerical Methods for Aerospace Engineers** | METU | Feb 2019 – Jun 2019
* Conducted 5 consultation sessions and graded 3 major computational assignments (MATLAB ODE/PDE solvers) for 30+ undergraduate students.

**SI-PASS Leader & Instructor - MAT119 & MAT120 (Calculus)** | METU | Sep 2018 – May 2019
* Completed formal SI-PASS Leadership Training and facilitated weekly peer-assisted calculus problem-solving sessions.

**STEM Project Mentor** | Young Scientists Kenya (YSK) | Jan 2020 – Dec 2021
* Mentored a secondary-school hydrogen-hybrid engine project achieving a 43.6% fuel efficiency increase at the national exhibition.
* Mentored a portable aircraft refueling rig project resulting in a functional automated dispenser bench prototype.

---

## LEADERSHIP & MENTORSHIP

**Vice President, Aerospace Society** | METU | Sep 2017 – Jun 2018
...
**President, Model United Nations Society** | METU | Sep 2017 – Jun 2018
* Revived the dormant campus MUN chapter, designed weekly training curricula, and led a 17-member student delegation to MUNTR 2018 in Antalya.

**Secretary General, International Students Association** | METU | Sep 2016 – Jan 2018
* Managed daily operations across 8 directorates and served as executive representative for the international student body, directing flagship campus-wide festivals.
