...
## 2. Core Competencies (Full Domain Taxonomy from `dev.db` Tag Library)

### Systems Engineering Lifecycle

Allocation, Architecture, CONOPS, Deployment, Design, Flight Testing, Functional Analysis, Ground Testing, Implementation, Integration, Interface Definition, Maintenance, Operations, Requirements, Requirements Management, Validation, Verification

### Technical Domains

AI (Artificial Intelligence), Advanced Air Mobility, Aerodynamics, Agronomy, Aircraft Design, Aircraft Systems, Autonomy, Avionics, CFD (Computational Fluid Dynamics), Certification, Cloud Architecture/ Cloud Computing, Communications, Computer Vision, Data Processing, Defense/ISR, Electrical Systems, Embedded Systems, Flight Controls, Flight Test, Ground Control Systems, IFR (Instrument Flight Rules), International Relations, Mission Planning, Mobile Development, Model Based Systems Engineering, Multispectral Imaging, Numerical Methods, Operations, Payloads, Photogrammetry, Policy Analysis, Precision Agriculture, Propulsion, Raymer Methodology, Regulatory Compliance, Research, Robotics, SIPASS, Safety, Sensors, Simulation, Software, Structural Analysis, Structures, Systems Engineering, UAS Training & Instruction, Venture Capital & Accelerator, Website Development, eVTOL

### Skills & Tools

3D Printing, ANSYS, ANSYS Fluent, CFX, ICEM, ANSYS Mechanical APDL, Abaqus CAE, ArduPilot, Arduino, AutoCAD, Autodesk Inventor, Azure, C, C++, CAN, CATIA, CPACS, ClickUp, Cosmos DB, Docker, Embedded C, Ethernet, FORTRAN, FastAPI, Firebase, Firestore, Flight Controller Hardware, Flight Simulation, GCP, GCP (Google Cloud Platform), GIS Tools, Git, HIL, HTML/CSS, Java, Kotlin, MATLAB, MBSE, MIL-SPEC Connectors, Mechanical Assembly , Mechanical Fabrication, Microsoft Office, MySQL, Notion, OpenFOAM, PAWAT, PX4, Pix4D , Python, QGIS, QGroundControl, RCE (Remote Component Environment), ROS, RS-232, RS-422, Raspberry Pi, React, Simulink, Soldering, SolidWorks, Supplier Sourcing, TDD (Test Driven Development), TTL, Tailwind CSS, TiGL/TiXi, UART, Unity, Vertex AI, Wire Harness Design, XFLR5, XFLR5/Flow5, yEd

### Other (Venture / Governance / Teaching / Academic)

Academic Publication, Bill of Materials (BOM), Business Development, Cap table & Equity Structuring, Corporate Governance, Digital Marketing, Diplomacy, Event Management, Financial Modeling , Fundraising, Investor Relations, Lega & Compliance, Market Research, Project Management, Public Speaking & Debate, Quality Assurance, Recruitment & Team Building, Stakeholder Engagement, Student Advocacy, Technical Documentation, Training Program Design, UX/ Field Validation, Venture Building

## 3. Complete Professional Experience (All 20 Experiences)

### Kipepeo Aerospace — Founding CEO & Lead Systems Engineer
*Startup | Nairobi, Kenya | 2024-10 – Present*
...
**Projects under this experience (7):**

#### Project: TAI UAS - Tactical Aerial Intelligence Platform 
...
- **R&D Project:** Yes
- **Project Tags:** Advanced Air Mobility, Aerodynamics, Aircraft Systems, Architecture, AutoCAD, Autodesk Inventor, Autonomy, Avionics, Bill of Materials (BOM), CONOPS, Design, Functional Analysis, Interface Definition, Payloads, Propulsion, Sensors, Structures, Supplier Sourcing, Systems Engineering, eVTOL, yEd

**Activity 1 — What:** Executed the initial aircraft design lifecycle for the TAI UAS, capturing system-level requirements and conducting preliminary aerodynamic and sizing trade studies for a 2-meter delta-wing hybrid VTOL platform
...
**Tags:** Aerodynamics, Aircraft Systems, Allocation, Architecture, Autonomy, Avionics, CONOPS, Design, Functional Analysis, MATLAB, Mission Planning, Payloads, Propulsion, Requirements, Requirements Management, Research, Simulation, Structures, Systems Engineering, Technical Documentation, XFLR5/Flow5, eVTOL

**Notes:** Requirements matrix finalized in TAI UAS Requirements.xlsx under document ID KIL-TAI. Aerodynamic sizing calculated in MATLAB and simulated in XFLR5; physical flight testing is pending funding.

**Activity 2 — What:** Authored the complete system architecture for the TAI UAS, translating high-level mission requirements into functional allocations, subsystem definitions, and a detailed electrical/control schematic
...
**Tags:** Aircraft Systems, Allocation, Architecture, AutoCAD, Autodesk Inventor, Autonomy, Avionics, CONOPS, Communications, Design, Electrical Systems, Embedded Systems, Flight Controls, Functional Analysis, Ground Control Systems, Interface Definition, PX4, Payloads, Propulsion, Raspberry Pi, Requirements, Safety, Sensors, Software, Systems Engineering, Technical Documentation, eVTOL, yEd

**Notes:** Architectural drawing finalized on 2/6/2025 (TAI Full System Architecture.png). Integrates Raspberry Pi 4B as the companion computer (DCU) for payload-to-flight-controller communication.

**Activity 3 — What:** Modeled the 3D mechanical CAD assembly for the TAI delta-wing hybrid VTOL airframe in Autodesk Inventor, incorporating internal structural housing for avionics, propulsion mounts, and modular payload bays
...
**Tags:** Aerodynamics, Aircraft Systems, Architecture, AutoCAD, Autodesk Inventor, Avionics, Design, Interface Definition, Payloads, Propulsion, Structures, Systems Engineering, Technical Documentation, eVTOL

**Notes:** Complete CAD assembly maintained in Autodesk Inventor format; physical airframe fabrication pending pre-seed funding.

**Activity 4 — What:** Conducted market trade studies, component matching, and cost estimations to compile the full Bill of Materials (BOM) for the TAI UAS platform
...
**Tags:** Aircraft Systems, Allocation, Avionics, Bill of Materials (BOM), Communications, Electrical Systems, Embedded Systems, Implementation, Payloads, Propulsion, Quality Assurance, Sensors, Supplier Sourcing, Systems Engineering, Technical Documentation, eVTOL

**Notes:** Complete itemized BOM documented in TAI UAS BOM.xlsx. Physical procurement is paused pending funding allocation.

#### Project: Kilimo Anga — Quadrotor Testbed & AngaCam Payload Integration
...
- **R&D Project:** No
- **Project Tags:** 3D Printing, Aircraft Systems, Allocation, Architecture, Autodesk Inventor, Avionics, Bill of Materials (BOM), Design, Electrical Systems, Embedded Systems, Functional Analysis, Interface Definition, Payloads, Propulsion, Raspberry Pi, Requirements, Requirements Management, Sensors, Supplier Sourcing, Systems Engineering, Technical Documentation

**Activity 5 — What:** Derived technical specifications and operational requirements for an agile, low-cost quadrotor testbed and multispectral payload based on farmer feedback from the Kilimo Anga initiative.
...
**Tags:** Aircraft Systems, Autonomy, CONOPS, Functional Analysis, Mission Planning, Payloads, Photogrammetry, Precision Agriculture, Requirements, Requirements Management, Sensors, Systems Engineering, Technical Documentation

**Notes:** Requirements derived directly from agricultural user feedback to ensure field operational viability.

**Activity 6 — What:** Engineered the electrical, power distribution, and flight control architecture for the F450-based quadrotor testbed.
...
**Tags:** Aircraft Systems, Allocation, Architecture, AutoCAD, Avionics, Communications, Data Processing, Design, Electrical Systems, Embedded Systems, Flight Controls, Interface Definition, PX4, Propulsion, Raspberry Pi, Systems Engineering, Technical Documentation

**Notes:** Architecture details documented in component specifications and system schematics.

**Activity 7 — What:** Designed the 3D mechanical housing and optical mounting for the custom AngaCam multispectral payload in Autodesk Inventor.
...
**Tags:** 3D Printing, Aircraft Systems, Architecture, Autodesk Inventor, Avionics, Design, Embedded Systems, Interface Definition, Multispectral Imaging, Payloads, Raspberry Pi, Sensors, Structures, Systems Engineering, Technical Documentation

**Notes:** CAD files maintained in Autodesk Inventor format

**Activity 8 — What:** Performed component trade studies and compiled the master Bill of Materials (BOM) for the quadrotor testbed and AngaCam payload.
...
**Tags:** 3D Printing, Aircraft Systems, Allocation, AutoCAD, Autodesk Inventor, Avionics, Bill of Materials (BOM), Communications, Electrical Systems, Embedded Systems, Implementation, Multispectral Imaging, PX4, Payloads, Raspberry Pi, Sensors, Stakeholder Engagement, Supplier Sourcing, Systems Engineering, Technical Documentation, yEd

**Notes:** Complete itemized BOM documented

#### Project: AngaStack V1 Platform Development
...
- **R&D Project:** Yes
- **Project Tags:** Architecture, Azure, CONOPS, Cloud Architecture/ Cloud Computing, Cosmos DB, Data Processing, Deployment, Design, Docker, FastAPI, Functional Analysis, Git, Implementation, Integration, Interface Definition, Operations, Precision Agriculture, Project Management, Python, Quality Assurance, React, Requirements, Requirements Management, Software, Stakeholder Engagement, Systems Engineering, Tailwind CSS, UX/ Field Validation, Validation, Verification
- **Notes:** Baseline Azure codebase tagged as release v0.1.0-azure and archived. Includes early AngaDemo web prototype development and user validation work.

**Activity 9 — What:** Local Photogrammetry Pipeline Development & Algorithm Verification
...
**Tags:** Architecture, Computer Vision, Data Processing, Design, GIS Tools, Implementation, Integration, Multispectral Imaging, Photogrammetry, Precision Agriculture, Python, Quality Assurance, Software, Systems Engineering, Technical Documentation, Verification, yEd

**Notes:** Served as the core algorithmic proof-of-concept for the AngaCloud processing engine before containerization and cloud orchestration.

**Activity 10 — What:** Full-Stack Application Development (AngaView UI & AngaCloud Backend)
...
**Tags:** Architecture, Data Processing, Design, FastAPI, Functional Analysis, Git, Implementation, Integration, Interface Definition, Precision Agriculture, Python, Quality Assurance, React, Software, Systems Engineering, Tailwind CSS, Technical Documentation, Verification

**Notes:** Built as the local software baseline before cloud infrastructure provisioning and containerization on Microsoft Azure

**Activity 11 — What:** Azure Cloud Infrastructure Provisioning & Live Platform Deployment
...
**Tags:** Architecture, Azure, Cloud Architecture/ Cloud Computing, Computer Vision, Cosmos DB, Data Processing, Deployment, Docker, FastAPI, GIS Tools, Git, Implementation, Integration, Interface Definition, Maintenance, Operations, Photogrammetry, Precision Agriculture, Project Management, Python, Quality Assurance, React, Software, Systems Engineering, Technical Documentation, Verification

**Notes:** Codebase snapshot tagged as release v0.1.0-azure and archived across polyrepo repositories prior to GCP re-architecture planning

**Activity 12 — What:** AngaDemo Digital Prototype Build & Field Usability Validation
...
**Tags:** CONOPS, Data Processing, Design, GIS Tools, Git, Implementation, Operations, Precision Agriculture, Python, React, Software, Stakeholder Engagement, Systems Engineering, Tailwind CSS, UX/ Field Validation, Validation

**Notes:** Deployed to preserve cloud credits and eliminate system complexity during early field validation before initiating the GCP re-architecture

#### Project: Kilimo Anga - Field Operations, Pre-Pilot Readiness & Business Model
...
- **R&D Project:** No
- **Project Tags:** Agronomy, CONOPS, ClickUp, Data Processing, Financial Modeling , Functional Analysis, Fundraising, Market Research, Microsoft Office, Notion, Operations, Precision Agriculture, Project Management, Requirements, Requirements Management, Software, Stakeholder Engagement, Systems Engineering, UX/ Field Validation, Validation, Venture Building, yEd
- **Notes:** Developed through Jasiri4Africa, #MyLittleBigThing, and Startup360 A2Finance accelerator programs

**Activity 13 — What:** Farmer Persona Discovery
...
**Tags:** Agronomy, CONOPS, ClickUp, Functional Analysis, Market Research, Microsoft Office, Notion, Precision Agriculture, Requirements, Software, Stakeholder Engagement, Systems Engineering, UX/ Field Validation, Validation, Venture Building

**Notes:** Foundational discovery work conducted during the #MyLittleBigThing and Jasiri4Africa programs to ground product development in real farmer behavior

**Activity 14 — What:** Competitor Gap Analysis & Fail-Point Mapping
...
**Notes:** Used to refine the value proposition and messaging presented in accelerator dossiers and investor pitches.

**Activity 15 — What:** Cost of Status Quo (CoSQ) Financial & Impact Modeling
...
**Tags:** Agronomy, CONOPS, ClickUp, Data Processing, Financial Modeling , Functional Analysis, Fundraising, Market Research, Microsoft Office, Notion, Precision Agriculture, Project Management, Requirements, Software, Stakeholder Engagement, Systems Engineering, Validation, Venture Building

**Notes:** Served as the core quantitative foundation for investor presentations, S360 A2Finance pitch sessions, and the #MLBT competition

**Activity 16 — What:** Credit-in-Kind Business Model & Value Chain Offloading Design
...
**Tags:** Agronomy, CONOPS, ClickUp, Financial Modeling , Functional Analysis, Market Research, Microsoft Office, Notion, Operations, Precision Agriculture, Project Management, Requirements, Software, Stakeholder Engagement, Systems Engineering, Validation, Venture Building

**Notes:** Directly resolved the "cash-at-planting" market truth identified during Ndabibi field interviews

**Activity 17 — What:** Pre-Pilot Ecosystem Partnerships, Governance & Investor Readiness
...
**Tags:** Agronomy, CONOPS, ClickUp, Financial Modeling , Functional Analysis, Fundraising, Market Research, Microsoft Office, Notion, Operations, Precision Agriculture, Project Management, Requirements, Software, Stakeholder Engagement, Systems Engineering, UX/ Field Validation, Validation, Venture Building

**Notes:** Formally transitioned Kilimo Anga from an early project concept into an investment-ready, legally governed, and partner-backed venture.

#### Project: AngaStack V2 Platform Development - GCP Cloud Migration, Mobile Ingestion & AngAi Engine
...
- **R&D Project:** Yes
- **Project Tags:** AI (Artificial Intelligence), Agronomy, Architecture, Azure, CONOPS, Cloud Architecture/ Cloud Computing, Computer Vision, Data Processing, Deployment, Design, Docker, FastAPI, Firebase, Firestore, Functional Analysis, GCP (Google Cloud Platform), GIS Tools, Git, Implementation, Integration, Interface Definition, Maintenance, Mobile Development, Operations, Precision Agriculture, Project Management, Python, Quality Assurance, React, Requirements, Requirements Management, Software, Systems Engineering, Tailwind CSS, Technical Documentation, Validation, Venture Building, Verification, Vertex AI, Website Development
- **Notes:** Baseline Azure codebase tagged as v0.1.0-azure; active migration and feature build executed on gcp-migration branches across all application repositories

**Activity 18 — What:** GCP Infrastructure Provisioning & IAM Security Architecture
...
**Tags:** Architecture, Azure, Cloud Architecture/ Cloud Computing, Deployment, Design, Docker, Firebase, Firestore, GCP (Google Cloud Platform), Git, Implementation, Integration, Interface Definition, Operations, Project Management, Quality Assurance, Requirements, Software, Systems Engineering, Technical Documentation, Venture Building, Verification

**Notes:** Serves as the completed Phase 0 and Phase 1 infrastructure milestone. Preserved a clean rollback baseline by tagging the legacy Azure deployment as release v0.1.0-azure prior to GCP setup

**Activity 19 — What:** Photogrammetry Pipeline GCP Migration & Numerical Stats Extraction
...
**Tags:** Architecture, Azure, Cloud Architecture/ Cloud Computing, Computer Vision, Data Processing, Deployment, Design, Docker, Functional Analysis, GCP (Google Cloud Platform), GIS Tools, Git, Implementation, Integration, Interface Definition, Operations, Precision Agriculture, Python, Quality Assurance, Software, Systems Engineering, Technical Documentation, Venture Building, Verification

**Notes:** Serves as the completed Phase 2 pipeline migration milestone, fully decoupling batch processing completion from backend API polling.

**Activity 20 — What:** Backend Service Refactoring, Dual-Path Ingestion & Job Orchestration
...
**Tags:** AI (Artificial Intelligence), Architecture, Cloud Architecture/ Cloud Computing, Computer Vision, Data Processing, Deployment, Design, Docker, FastAPI, Firebase, Firestore, Functional Analysis, GCP (Google Cloud Platform), Git, Implementation, Integration, Interface Definition, Mobile Development, Operations, Precision Agriculture, Python, Quality Assurance, Software, Systems Engineering, Technical Documentation, Venture Building, Verification, Vertex AI

**Notes:** Serves as the Phase 3 backend migration milestone, unifying mobile crop disease diagnostics with drone batch photogrammetry orchestration

**Activity 21 — What:** AngAi Agronomic Reasoning Engine & RAG Microservice Build
...
**Tags:** AI (Artificial Intelligence), Agronomy, Architecture, Cloud Architecture/ Cloud Computing, Computer Vision, Data Processing, Deployment, Design, Docker, FastAPI, Firestore, Functional Analysis, GCP (Google Cloud Platform), Git, Implementation, Integration, Interface Definition, Operations, Python, Quality Assurance, Software, Systems Engineering, Technical Documentation, Venture Building, Verification, Vertex AI

**Notes:** Serves as the Phase 4 AI engine milestone, leveraging GCP-native Vertex AI and Firestore Vector Search to eliminate external third-party API keys and custom model training overhead

**Activity 22 — What:** AngaView Mobile Ingestion, Firebase Hosting & Living Farm Health Record UI
...
**Tags:** AI (Artificial Intelligence), Agronomy, Architecture, Cloud Architecture/ Cloud Computing, Computer Vision, Data Processing, Deployment, Design, Docker, FastAPI, Firebase, Firestore, Functional Analysis, GCP (Google Cloud Platform), Git, Implementation, Integration, Interface Definition, Maintenance, Mobile Development, Operations, Precision Agriculture, Project Management, Python, Quality Assurance, React, Requirements, Requirements Management, Software, Systems Engineering, Tailwind CSS, Technical Documentation, Validation, Venture Building, Verification, Vertex AI

**Notes:** Serves as the Phase 5 frontend milestone, establishing the living farm record UI and completing end-to-end integration across the 5 AngaStack repositories

#### Project: Linda Nchi — Sovereign Tactical ISR Platform & K-DEMO-2.5 Cargo Demonstrator
...
- **R&D Project:** Yes
- **Project Tags:** AI (Artificial Intelligence), Advanced Air Mobility, Aerodynamics, Aircraft Systems, Architecture, Autodesk Inventor, Autonomy, Avionics, Bill of Materials (BOM), C++, CAN, CONOPS, Cloud Architecture/ Cloud Computing, Communications, Computer Vision, Data Processing, Defense/ISR, Design, Electrical Systems, Embedded Systems, Ethernet, Financial Modeling , Flight Controls, Functional Analysis, Git, Ground Control Systems, HIL, Interface Definition, MATLAB, MIL-SPEC Connectors, Market Research, Mechanical Assembly , Mechanical Fabrication, Operations, PX4, Payloads, Project Management, Propulsion, Python, QGIS, QGroundControl, Quality Assurance, Requirements, Requirements Management, Research, Robotics, Safety, Sensors, Software, Stakeholder Engagement, Structures, Supplier Sourcing, Systems Engineering, Technical Documentation, Venture Building, Verification, Wire Harness Design, eVTOL
- **Notes:** Developed following institutional deliberations with defense stakeholders; serves as Kipepeo Aerospace's secondary enterprise line alongside Kilimo Anga

**Activity 23 — What:** Defense Stakeholder Requirement Synthesis & Use-Case Mapping
...
**Tags:** CONOPS, Defense/ISR, Functional Analysis, Market Research, Microsoft Office, Operations, Requirements, Requirements Management, Safety, Stakeholder Engagement, Systems Engineering, Technical Documentation, Validation, Venture Building

**Notes:** Derived from direct consultations with defense contacts to align technical capabilities with sovereign security and statutory requirements

**Activity 24 — What:** Linda Nchi Tactical ISR System Architecture & Technical Roadmap Authoring
...
**Tags:** AI (Artificial Intelligence), Advanced Air Mobility, Aircraft Systems, ArduPilot, Autonomy, Avionics, C++, CAN, CONOPS, Cloud Architecture/ Cloud Computing, Communications, Computer Vision, Data Processing, Defense/ISR, Design, Docker, Electrical Systems, Embedded Systems, Ethernet, FastAPI, Firebase, Firestore, Flight Controls, Functional Analysis, GCP (Google Cloud Platform), Ground Control Systems, Interface Definition, Microsoft Office, PX4, Payloads, Project Management, Propulsion, Python, QGIS, QGroundControl, Requirements, Research, Robotics, Safety, Sensors, Systems Engineering, Technical Documentation, Venture Building, eVTOL

**Notes:** Serves as the primary technical reference and architectural blueprint for Kipepeo Aerospace's sovereign defense ecosystem.

**Activity 25 — What:** Project K-DEMO-2.5 Heavy-Lift Cargo Hexacopter Mechanical Engineering & Stress Analysis
...
**Tags:** 3D Printing, Advanced Air Mobility, Aerodynamics, Aircraft Systems, Architecture, Autodesk Inventor, Bill of Materials (BOM), CAN, CONOPS, Defense/ISR, Design, Electrical Systems, Embedded Systems, Ethernet, Financial Modeling , Flight Controls, Functional Analysis, Ground Control Systems, Interface Definition, MATLAB, MIL-SPEC Connectors, Mechanical Assembly , Mechanical Fabrication, Microsoft Office, Payloads, Project Management, Propulsion, Quality Assurance, Requirements, Research, Robotics, Safety, Structures, Supplier Sourcing, Systems Engineering, Technical Documentation, Verification

**Notes:** Formally locked baseline configuration V1.0 for the Project K-DEMO-2.5 physical prototype build

#### Project: Kipepeo Venture Building, Governance & Capital Strategy
...
- **R&D Project:** No
- **Project Tags:** Bill of Materials (BOM), CONOPS, Cap table & Equity Structuring, Certification, ClickUp, Corporate Governance, Design, Financial Modeling , Fundraising, Investor Relations, Lega & Compliance, Market Research, Microsoft Office, Notion, Operations, Operations, Precision Agriculture, Project Management, Recruitment & Team Building, Requirements, Requirements Management, Research, Stakeholder Engagement, Systems Engineering, Technical Documentation, Venture Building, Venture Capital & Accelerator
- **Notes:** Captures the full corporate evolution from the July 2020 Drones4Kenya concept at Konza Technopolis, official business registration under BN-BGCKDY99 in October 2023, Jasiri talent residency in Rwanda (Nov 2024 – June 2025), solo pivot and domain/website launches (kipepeo.space & kilimoanga.kipepeo.space), recruitment of COO Brian Kihumba, #MyLittleBigThing Top 50 & 30-Day Build/Test challenge, execution of the Pre-Incorporation Founders' Agreement in April 2026, S360 Access to Finance Showcase, $1,000 SAFE investment from Zimbu Investments Limited, and onboarding into the 2026–2027 Investor Readiness Program (IRP).

**Activity 26 — What:** Formulated the foundational vision, operational roadmap, and financial budget for establishing an indigenous drone technology hub at Konza Technopolis
...
**Tags:** CONOPS, ClickUp, Design, Financial Modeling , Market Research, Microsoft Office, Notion, Precision Agriculture, Project Management, Recruitment & Team Building, Requirements, Research, Stakeholder Engagement, Systems Engineering, Technical Documentation, Venture Building, Venture Capital & Accelerator

**Notes:** Drones4Kenya team comprised 5 youth members led by Brian Lembuss (Team Leader & Head of Operations). Proposal PDF and PowerPoint presentation exist as evidence

**Activity 27 — What:** Executed formal business name registration and statutory setup to legally establish Kipepeo Aerospace in Nairobi, Kenya
...
**Tags:** Certification, Corporate Governance, Lega & Compliance, Operations, Requirements, Venture Building

**Notes:** Registered while completing MSc studies in Germany prior to returning full-time to Kenya in late 2024. Official BRS Certificate PDF exists as evidence

**Activity 28 — What:** Participated in the 3-month Jasiri Talent Investor residential intensive in Bugesera, Rwanda, conceptualizing the iCARUS precision agriculture venture and conducting smallholder agri-data market research
...
**Tags:** Agronomy, CONOPS, Cap table & Equity Structuring, ClickUp, Design, Financial Modeling , Fundraising, Investor Relations, Lega & Compliance, Market Research, Microsoft Office, Notion, Operations, Precision Agriculture, Project Management, Recruitment & Team Building, Requirements, Research, Stakeholder Engagement, Systems Engineering, Technical Documentation, Validation, Venture Building, Venture Capital & Accelerator

**Notes:** Fully funded 14-month entrepreneurship program by Allan & Gill Gray Philanthropy (Cohort 7 / Ntore Cohort). Official recommendation letter (April 7, 2025), GeoPoll brief, BMC, and pitch deck exist as evidence

**Activity 29 — What:** Applied for and secured non-dilutive cloud infrastructure grant funding through the Microsoft for Startups Founders Hub program
...
**Tags:** Azure, Cloud Architecture/ Cloud Computing, Deployment, Fundraising, Microsoft Office, Operations, Project Management, Requirements, Software, Venture Building, Venture Capital & Accelerator

**Notes:** Co-applied with former co-founder Adrian Kiplimo prior to his departure in June 2025. Cloud credits directly funded Azure infrastructure provisioning

**Activity 30 — What:** Negotiated and executed three strategic Memorandums of Understanding (MoUs) with Stablegen Investment Ltd. to establish pilot market access, software testing, and drone corridor access
...
**Tags:** CONOPS, Certification, Corporate Governance, Lega & Compliance, Microsoft Office, Operations, Operations, Precision Agriculture, Project Management, Requirements, Research, Stakeholder Engagement, Systems Engineering, Technical Documentation, Venture Building

**Notes:** All three signed MoU documents exist as evidence

**Activity 31 — What:** Registered core internet domains, established digital brand presence, and deployed web infrastructure for Kipepeo Aerospace and its flagship initiative Kilimo Anga
...
**Tags:** Deployment, Design, Operations, Operations, Precision Agriculture, Project Management, React, Research, Stakeholder Engagement, Tailwind CSS, Technical Documentation, Venture Building, Website Development

**Notes:** Solitary founder effort executed in Nairobi following the return from Germany and dissolution of early MoUs.

**Activity 32 — What:** Conducted talent acquisition campaigns, restructured executive roles, and established a specialized advisory board to strengthen Kipepeo Aerospace's commercial, legal, and agronomic leadership
...
**Tags:** Agronomy, CONOPS, Corporate Governance, Lega & Compliance, Microsoft Office, Operations, Operations, Project Management, Recruitment & Team Building, Requirements, Research, Stakeholder Engagement, Systems Engineering, Venture Building

**Notes:** ob description document (Role - Business Development Lead.docx) and organizational chart PDF exist as primary evidence.

**Activity 33 — What:** Applied for the MK-Africa #MyLittleBigThing Sustainable Venture Challenge with Kilimo Anga, securing selection into the Top 50 and completing the two-day Innovation Bootcamp.
...
**Tags:** Agronomy, CONOPS, Design, Financial Modeling , Fundraising, Investor Relations, Market Research, Microsoft Office, Operations, Precision Agriculture, Project Management, Requirements, Research, Technical Documentation, Validation, Venture Building, Venture Capital & Accelerator

**Notes:** Organized by MK-Africa in partnership with Strathmore University, Safaricom, Absa, and Sanlam Allianz. Top 50 selection notification email and completed Bootcamp Innovator's Workbook exist as evidence

**Activity 34 — What:** Executed the 30-Day Build & Test Challenge for #MyLittleBigThing, deploying the AngaDemo digital prototype and conducting field usability and willingness-to-pay (WTP) validation studies
...
**Tags:** Agronomy, CONOPS, Deployment, Design, Financial Modeling , Fundraising, Investor Relations, Microsoft Office, Operations, Precision Agriculture, React, Requirements, Research, Software, Tailwind CSS, Technical Documentation, UX/ Field Validation, Validation, Venture Building, Venture Capital & Accelerator, Verification, Website Development

**Notes:** Official Phase 3 notification email, Evidence of Build PDF, Evidence of Test PDF, Marketing Budget annex, and Demo Day Pitch Deck exist as evidence

**Activity 35 — What:** Applied for and secured non-dilutive cloud infrastructure grant funding from the Google Cloud for Startups program
...
**Tags:** AI (Artificial Intelligence), Cloud Architecture/ Cloud Computing, Deployment, Fundraising, GCP (Google Cloud Platform), Microsoft Office, Operations, Project Management, Requirements, Software, Venture Building, Venture Capital & Accelerator, Vertex AI

**Notes:** Sourced in early 2026 to complement the 2025 Microsoft Azure grant and eliminate third-party API costs during platform re-architecture

**Activity 36 — What:** Completed the Viktoria Ventures Startup360 Access to Finance (A2F) Programme and authored the $30,000 pre-seed investor readiness dossier and financial model for Kilimo Anga
...
**Tags:** Agronomy, CONOPS, Design, Financial Modeling , Fundraising, Investor Relations, Market Research, Microsoft Office, Operations, Precision Agriculture, Project Management, Requirements, Research, Systems Engineering, Technical Documentation, Venture Building, Venture Capital & Accelerator

**Notes:** Master schedule PDF, Investor Q&A Brief PDF, Investment Memo PDF, 12-Month Cash Flow Excel, and Pitch Deck PDF exist as primary evidence.

**Activity 37 — What:** Authored and executed the binding Kipepeo Aerospace Pre-Incorporation Founders' Agreement, establishing legal governance, cap table ownership, reverse vesting, and operational decision hierarchies under Kenyan law
...
**Tags:** Cap table & Equity Structuring, Certification, Corporate Governance, Lega & Compliance, Microsoft Office, Operations, Operations, Project Management, Recruitment & Team Building, Requirements, Requirements Management, Research, Safety, Technical Documentation, Venture Building

**Notes:** Full signed Founders' Agreement PDF and Schedule A Cap Table PDF exist as primary evidence

**Activity 38 — What:** Negotiated and executed the first formal early-stage investment agreement for Kipepeo Aerospace via a Simple Agreement for Future Equity (SAFE) with Zimbu Investments Limited.
...
**Tags:** Cap table & Equity Structuring, Certification, Corporate Governance, Fundraising, Investor Relations, Lega & Compliance, Microsoft Office, Operations, Project Management, Requirements, Research, Stakeholder Engagement, Venture Building, Venture Capital & Accelerator

**Notes:** Executed Investment Letter and SAFE Agreement documents exist as primary evidence

**Activity 39 — What:** Applied for and onboarded into the 12-Month #MyLittleBigThing Investor Readiness Program (IRP) Pilot Cohort (2026–2027) co-delivered by MK-Africa and Strathmore @iBizAfrica
...
**Tags:** CONOPS, Cap table & Equity Structuring, Certification, Corporate Governance, Deployment, Financial Modeling , Fundraising, Investor Relations, Lega & Compliance, Microsoft Office, Operations, Precision Agriculture, Project Management, Requirements, Research, Stakeholder Engagement, Technical Documentation, Venture Building, Venture Capital & Accelerator

**Notes:** Submission completed prior to the June 26, 2026 deadline. 2026 IRP Program Brief PDF and completed Participant Details Profile exist as primary evidence
...
**Projects under this experience (8):**

#### Project: Numerical Methods for Aerospace Engineers 
...
- **R&D Project:** No
- **Project Tags:** Aerodynamics, CFD (Computational Fluid Dynamics), FORTRAN, Implementation, MATLAB, Numerical Methods, Simulation, Software, Verification
- **Notes:** Group of 3 (Ian Solomon, Rafik Kawas, Brian Kirwa). Brian led implementation across all three assignments. Supervised by Dr. Ismail H. Tuncer, METU NCC Aerospace Engineering. Assignments 3, 4, and 5 on file; Assignments 1 and 2 not available.

**Activity 1 — What:** Developed a 2D finite volume solver in FORTRAN to compute potential flow over a NACA 0012 airfoil and a circle at multiple angles of attack.
...
**Tags:** Aerodynamics, CFD (Computational Fluid Dynamics), FORTRAN, Implementation, Numerical Methods, Simulation, Software, Verification

**Notes:** NACA 0012 geometry defined via .d input file for EasyMesh. Grid topology stored in .dat format; output in Tecplot-compatible .plt format

**Activity 2 — What:** Implemented and compared explicit and implicit 1D finite difference schemes for an unsteady heat diffusion equation (parabolic PDE) and a linear convection equation (hyperbolic PDE).
...
**Notes:** Domain: T(0,t)=15, T(100,t)=100, IC T(x,0)=10 for heat equation; sinusoidal IC on [0,π] for convection equation.

**Activity 3 — What:** Implemented FTCS and DuFort-Frankel schemes to solve the 2D unsteady convection-diffusion equation over a rectangular domain, with parametric studies on grid resolution, convection velocity, and initial condition geometry
...
**Tags:** Aerodynamics, CFD (Computational Fluid Dynamics), FORTRAN, Implementation, Simulation, Software, Verification

#### Project: Finite Element Modelling of a Composite Cantilever Beam
...
- **R&D Project:** No
- **Project Tags:** ANSYS Mechanical APDL, Design, Simulation, Software, Structural Analysis, Structures, Verification
- **Notes:** Supervised by Dr. Pelin Berik, Mechanical Engineering, METU NCC. Both projects individually executed and submitted. Term project completed November 2018; Final project completed December 2018.

**Activity 4 — What:** Performed static 3D FEA of a 5-layer composite cantilever beam (3 aluminium + 2 glass fibre/epoxy, 500mm × 50mm) under a 5N transverse tip load to determine tip deflection and full stress distribution across all layers.
...
**Tags:** ANSYS Mechanical APDL, Implementation, Simulation, Software, Structural Analysis, Structures, Verification

**Activity 5 — What:** Performed multi-analysis 3D FEA of a 3-layer composite cantilever beam (1 aluminium core + 2 glass fibre/epoxy, 200mm × 40mm) under static and harmonic torsional moment loading (Mx = 1Nm), including modal frequency extraction and harmonic response analysis.
...
#### Project: Turbofan Compressor Performance Analysis
...
- **R&D Project:** Yes
- **Project Tags:** Design, MATLAB, Propulsion, Simulation, Software
- **Notes:** Submitted 6 January 2019. Group of two: Brian Kirwa and Kendra Kabeyeka Nambisia. Supervised by Dr. Mehmet Karaca, METU NCC. Project Assignment 2 on file; Assignment 1 not available.

**Activity 6 — What:** Conducted parametric analysis of turbofan compressor performance by modelling the effects of turbine inlet temperature, operating altitude, and turbine inlet area on corrected mass flow rate and compressor pressure ratio
...
**Tags:** Functional Analysis, Implementation, MATLAB, Propulsion, Simulation, Software

#### Project: Finite Difference Method Solvers for Aerodynamic PDEs
...
- **R&D Project:** No
- **Project Tags:** Aerodynamics, CFD (Computational Fluid Dynamics), Implementation, MATLAB, Numerical Methods, Simulation, Software, Verification
- **Notes:** Group of three: Brian Kirwa, Kendra Nambisia, Yusuf İnce. Supervised by Dr. Mehrdad Sichani, METU NCC. Submitted 17 January 2019. Term Project II on file.

**Activity 7 — What:** Led development of four MATLAB finite difference solvers covering elliptic, parabolic, and hyperbolic PDE classes, applying ASE301 numerical methods experience to architect the solution approach and implement stability-verified codes.
...
**Tags:** Aerodynamics, CFD (Computational Fluid Dynamics), Implementation, MATLAB, Numerical Methods, Simulation, Software, Verification

**Notes:** Led solver architecture and MATLAB implementation. Applied FDM derivations and stability analysis methods developed in ASE301 Numerical Methods for Aerospace Engineering (prior semester).

#### Project: Conceptual Design of a Fixed-Wing Luxury Aircraft (Graduation Project I)
...
- **R&D Project:** No
- **Project Tags:** Aerodynamics, Aircraft Design, AutoCAD, Autodesk Inventor, Design, MATLAB, Numerical Methods, Propulsion, Raymer Methodology, Requirements, Requirements Management, Research, Simulation, Structural Analysis, Systems Engineering, Technical Documentation, XFLR5/Flow5

**Activity 8 — What:** Defined customer design requirements and conducted a structured competitor benchmarking study across six business jet aircraft to anchor the conceptual design baseline.
...
**Tags:** Aerodynamics, Aircraft Design, Design, MATLAB, Raymer Methodology, Requirements, Requirements Management, Technical Documentation

**Activity 9 — What:** Estimated initial take-off gross weight W₀ using mission segment weight fractions and conducted parametric trade studies to characterise W₀ sensitivity to range, endurance, and payload.
...
**Tags:** Aircraft Design, Design, MATLAB, Numerical Methods, Propulsion, Raymer Methodology, Technical Documentation, Validation

**Activity 10 — What:** Selected the wing airfoil through comparative aerodynamic analysis of five candidate profiles and sized all primary wing geometry parameters.
...
**Tags:** Aerodynamics, Aircraft Design, Design, MATLAB, Numerical Methods, Raymer Methodology, Simulation, Technical Documentation, Validation, XFLR5/Flow5

**Notes:** Airfoil data sourced from airfoiltools.com. XFLR5 referenced for polar visualisation

**Activity 11 — What:** Determined final thrust-to-weight ratio and wing loading through multi-constraint parametric analysis, then refined the take-off gross weight estimate using updated mission segment fractions.
...
**Tags:** Aerodynamics, Aircraft Design, Design, MATLAB, Numerical Methods, Propulsion, Raymer Methodology, Simulation, Technical Documentation, Validation

**Activity 12 — What:** Sized all major airframe components — fuselage, wing, tail surfaces, and engines — and estimated the aircraft centre of gravity from component weight and moment arm data
...
**Tags:** Aerodynamics, Aircraft Design, Autodesk Inventor, Design, MATLAB, Numerical Methods, Propulsion, Raymer Methodology, Simulation, Structural Analysis, Technical Documentation, Validation

**Notes:** Fuselage wetted area (155.66 m²) computed in Autodesk Inventor for CG code input

**Activity 13 — What:** Designed the landing gear configuration, sized tyres and struts, validated geometric placement, and produced the final three-view layout drawing.
...
**Tags:** Aircraft Design, Autodesk Inventor, Design, MATLAB, Raymer Methodology, Structural Analysis, Structures, Technical Documentation, Validation

#### Project: Conceptual Design of a VTOL Personal Air Vehicle (Graduation Project II)
...
- **R&D Project:** No
- **Project Tags:** Advanced Air Mobility, Aerodynamics, Aircraft Design, Avionics, Design, Flight Controls, MATLAB, Numerical Methods, Propulsion, Requirements Management, Simulation, Structural Analysis, Technical Documentation, Validation, XFLR5/Flow5
- **Notes:** Group of 4 — Olivia Mwaniki, Kendra Nambisia, Gasser Abdelrahman, Brian K. Lembuss Kirwa. Submitted to Dr. Anna Prach, 27 May 2019. Primary reference: Leishman, J. (2006), Principles of Helicopter Aerodynamics, 2nd Ed. Competitors benchmarked: Bell 407GXi, Eurocopter EC130, Bell 505, Eurocopter AS350, Enstrom 480B, Kopter SH09.

**Activity 14 — What:** Defined customer design requirements and benchmarked six light civil helicopters to establish the design baseline.
...
**Tags:** Advanced Air Mobility, Aircraft Design, Design, MATLAB, Propulsion, Requirements Management, Technical Documentation

**Activity 15 — What:** Selected the rotor airfoil and sized the main and tail rotors through Blade Element Momentum Theory analysis across three disk loading cases
...
**Tags:** Aerodynamics, Aircraft Design, Design, MATLAB, Numerical Methods, Simulation, Technical Documentation, Validation, XFLR5/Flow5

**Activity 16 — What:** Estimated helicopter component weights iteratively using empirical group equations and selected the engine based on power requirements.
...
**Tags:** Aircraft Design, Design, MATLAB, Numerical Methods, Propulsion, Simulation, Structural Analysis, Technical Documentation, Validation

**Activity 17 — What:** Computed total power required across the forward flight speed envelope to validate engine selection and characterise helicopter performance.
...
**Tags:** Aerodynamics, Aircraft Design, Design, MATLAB, Numerical Methods, Propulsion, Simulation, Technical Documentation, Validation

**Activity 18 — What:** Defined all major design configuration choices and produced the final three-view engineering drawing.
...
**Tags:** Advanced Air Mobility, Aerodynamics, Aircraft Design, Avionics, Design, Flight Controls, MATLAB, Safety, Structural Analysis, Technical Documentation, Validation

#### Project: Design and Development of an Automated Air Filter
...
- **R&D Project:** No
- **Project Tags:** Arduino, Design, Electrical Systems, Embedded C, Embedded Systems, Implementation, Integration, Robotics, Sensors, Software, Technical Documentation, Validation
- **Notes:** Group of 2 — Ihtesham Khan, Brian K. Lembuss Kirwa. Submitted to Prof. Dr. Eşref Eşkinat, 27 May 2019. Brian's standout contribution was systems integration and debugging

**Activity 19 — What:** Defined system requirements, selected all electromechanical components, and produced the full circuit schematic.
...
**Tags:** Arduino, Bill of Materials (BOM), Design, Electrical Systems, Embedded C, Embedded Systems, Requirements Management, Sensors, Software, Technical Documentation

**Activity 20 — What:** Developed Arduino firmware implementing sensor reading, dust density calculation, threshold-based control logic, and all output actuation
...
**Tags:** Arduino, Design, Electrical Systems, Embedded C, Embedded Systems, Implementation, Sensors, Software, Technical Documentation, Validation

**Activity 21 — What:** Fabricated the device housing, assembled all subsystems into a unified physical unit, resolved integration faults, and validated full system operation.
...
**Tags:** Arduino, Electrical Systems, Embedded C, Embedded Systems, Implementation, Integration, Sensors, Software, Technical Documentation, Validation

**Notes:** Brian led systems integration and debugging throughout this phase.

#### Project: Simulation of a piezoelectric d15 torsion sensor
...
- **R&D Project:** Yes
- **Project Tags:** Abaqus CAE, Design, Numerical Methods, Research, Sensors, Simulation, Structural Analysis, Technical Documentation, Validation
- **Notes:** Individual project. Submitted to Dr. Pelin Berik, Spring 2019. PIC255 piezoceramic (PZT-based) material. Reference: Sirohi & Chopra (2000), Fundamental Understanding of Piezoelectric Strain Sensors, Journal of Intelligent Material Systems and Structures, 11(4)

**Activity 22 — What:** Established the theoretical framework for the d₁₅ piezoelectric sensing effect and defined the full PIC255 material model in Abaqus CAE with dual-polarization patch assignment.
...
**Tags:** Abaqus CAE, Design, Numerical Methods, Research, Sensors, Simulation, Structural Analysis, Technical Documentation

**Activity 23 — What:** Built the full Abaqus CAE finite element model of the cantilevered piezoelectric beam including geometry, boundary conditions, constraints, and mesh.
...
**Tags:** Abaqus CAE, Design, Implementation, Numerical Methods, Simulation, Structural Analysis, Technical Documentation

**Activity 24 — What:** Executed three sequential FEA analyses — quasi-static, modal, and harmonic — to extract sensor voltages and electromechanical coupling coefficients across torsional modes.
...
**Tags:** Abaqus CAE, Numerical Methods, Research, Sensors, Simulation, Structural Analysis, Technical Documentation, Validation

**Notes:** All analyses conducted in Abaqus/Standard 3DEXPERIENCE R2017x.
...
**Activity 1 — What:** Co-managed administrative operations, budget allocation, society branding competitions, and collaborative events with partner student organizations
...
**Tags:** Operations, Operations, Project Management, Stakeholder Engagement

**Notes:** an election campaign emphasizing RAeS career flightpath resources, industry integration, equality, transparency, and collaborative project development.

**Activity 2 — What:** Initiated and coordinated the society's flagship hands-on model aircraft design and construction project team.
...
**Tags:** Aircraft Design, Aircraft Systems, Autodesk Inventor, Design, Integration, Recruitment & Team Building

**Notes:** Coordinated team application and interview process for members to pitch and develop project ideas.

**Activity 3 — What:** Organized and facilitated extracurricular technical software training courses in MATLAB and Autodesk Inventor for society members
...
**Tags:** Aircraft Systems, Autodesk Inventor, Implementation, MATLAB, Software, Training Program Design

**Notes:** Courses covered fundamental engineering computation in MATLAB and assembly modeling in Autodesk Inventor (MECH 114)

**Activity 4 — What:** Conceptualized, scheduled, and hosted academic guest lectures, faculty Q&A sessions, and technical seminars
...
**Tags:** Aircraft Systems, Operations, Research, Stakeholder Engagement

**Notes:** Seminars included materials presentations, fatigue impact research by Dean Owen, and faculty Q&A forums.
...
**Activity 1 — What:** Revived the dormant campus Model United Nations chapter, authored the official revival proposal, established administrative structures, and managed active member operations
...
**Tags:** Corporate Governance, Diplomacy, International Relations, Microsoft Office, Operations, Operations, Project Management, Recruitment & Team Building, Stakeholder Engagement

**Notes:** Revival was inspired by participation as delegate of the Russian Federation in SOCHUM at the Sub-Saharan International Model United Nations (SIMUN 2017) in Nairobi

**Activity 2 — What:** Designed and delivered weekly MUN training curricula while organizing guest lectures on diplomacy and international relations
...
**Tags:** Diplomacy, International Relations, Microsoft Office, Operations, Operations, Policy Analysis, Public Speaking & Debate, Research, Stakeholder Engagement, Training Program Design

**Notes:** Sessions convened weekly in campus seminar rooms to prepare members for national and regional MUN simulations.

**Activity 3 — What:** Led a 17-member student delegation to represent METU NCC at Model United Nations Turkey 2018 (MUNTR) in Antalya, Turkey
...
**Tags:** Diplomacy, International Relations, Microsoft Office, Operations, Operations, Policy Analysis, Project Management, Public Speaking & Debate, Research, Stakeholder Engagement

**Notes:** Also served as Deputy Secretary General on the World Youth Summit (WYS 2019) secretariat, later leading a principled collective resignation of METU student members over geopolitical/security concerns
...
*Internship | Wilson Airport, Nairobi | 2017-07 – 2017-09*
...
#### Project: Aircraft Line, Base & C-Check Maintenance — ALS Ltd MRO
...
- **R&D Project:** No
- **Project Tags:** Aircraft Systems, Avionics, Certification, Electrical Systems, Flight Controls, Maintenance, Mechanical Assembly , Mechanical Fabrication, Operations, Operations, Propulsion, Quality Assurance, Regulatory Compliance, Safety, Structures, Systems Engineering, Technical Documentation, Validation, Verification
- **Notes:** Supervised by Eng. Njenga (Beechcraft 1900C, 200HR), Eng. Karanja (DHC-8, line maintenance), and Eng. Kemboi (ERJ145MP, C-check). Overall supervisor: Maurice Mukung, Base Maintenance Manager. Internship conducted as METU ASE 300 requirement. All tasks performed as assistant — no independent sign-off authority.

**Activity 1 — What:** Assisted with fuel nozzle replacement on the PT6A-65B turboprop engine during a 200HR inspection on the Beechcraft 1900C
...
**Tags:** Aircraft Systems, Certification, Maintenance, Mechanical Assembly , Mechanical Fabrication, Operations, Propulsion, Quality Assurance, Regulatory Compliance, Safety, Systems Engineering, Technical Documentation, Validation, Verification

**Notes:** Task card issued by ALS operations team. Nozzle numbering sequence (clockwise from top, 8th nozzle connected to fuel divider) critical for correct reinstallation. Locking wire applied post-torque to prevent in-flight loosening

**Activity 2 — What:** Assisted with compressor wash on the PT6A-65B turboprop engine during a 200HR inspection on the Beechcraft 1900C
...
**Tags:** Aircraft Systems, Certification, Maintenance, Mechanical Assembly , Operations, Propulsion, Quality Assurance, Regulatory Compliance, Safety, Systems Engineering, Technical Documentation, Validation, Verification

**Notes:** Compressor wash is a scheduled 200HR maintenance task on PT6A series engines. Procedure follows manufacturer servicing manual requirements

**Activity 3 — What:** Assisted with propeller shaft greasing on the PT6A-65B turboprop engine during a 200HR inspection on the Beechcraft 1900C
...
**Tags:** Aircraft Systems, Certification, Maintenance, Mechanical Assembly , Operations, Propulsion, Quality Assurance, Regulatory Compliance, Safety, Structures, Systems Engineering, Technical Documentation, Validation

**Notes:** Aeroshell Grease 22 selected per manufacturer specification for PT6A propeller shaft lubrication. Greasing nipples required specific greasing gun socket attachment

**Activity 4 — What:** Assisted with de-icer boot reinstallation on the DHC-8 leading edges during line maintenance
...
**Tags:** Aircraft Systems, Certification, Flight Controls, Maintenance, Mechanical Assembly , Mechanical Fabrication, Operations, Propulsion, Quality Assurance, Regulatory Compliance, Safety, Structures, Systems Engineering, Technical Documentation, Validation, Verification

**Notes:** Thiokol sealant applied to prevent ingress and ensure aerodynamic seal between boot and wing surface. Task required 4 technicians due to physical scale of boot handling

**Activity 5 — What:** Assisted with flap ball screw assembly lubrication on the DHC-8 during line maintenance
...
**Tags:** Aircraft Systems, Certification, Flight Controls, Maintenance, Mechanical Assembly , Operations, Propulsion, Quality Assurance, Regulatory Compliance, Safety, Structures, Systems Engineering, Technical Documentation, Validation

**Notes:** Aeroshell Grease 33 specified for flap actuator application. Actuator lubrication required specialist tool to prevent grease escape during application.

**Activity 6 — What:** Assisted with cabin seat removal and hook-and-loop fastener replacement on the Embraer ERJ145MP during C-check
...
**Tags:** Aircraft Systems, Certification, Maintenance, Mechanical Assembly , Mechanical Fabrication, Operations, Quality Assurance, Regulatory Compliance, Safety, Structures, Systems Engineering, Technical Documentation, Validation, Verification

**Notes:** C-check requires full interior clearance for structural and systems access. ERJ145MP configured in 2×1 arrangement across 17 rows. MEK used as cleaning solvent for adhesive residue removal prior to new strip bonding.

**Activity 7 — What:** Assisted with nose landing gear servicing on the Embraer ERJ145MP during C-check
...
**Tags:** Aircraft Systems, Certification, Electrical Systems, Flight Controls, Maintenance, Mechanical Assembly , Operations, Quality Assurance, Regulatory Compliance, Safety, Structures, Systems Engineering, Technical Documentation, Validation, Verification

**Notes:** Fault detected during C-check inspection prompted nose gear maintenance. Hydraulic and brake fluid work conducted by a separate specialist team. Aircraft raised on 3-point jack configuration per AMM jacking procedure.
...
**Activity 1 — What:** Ground school training covering aviation theory, air law, navigation, meteorology, and aircraft systems
...
**Tags:** Aerodynamics, Aircraft Systems, Flight Controls, Operations, Regulatory Compliance, Requirements, Safety, Validation, Verification

**Notes:** Conducted January–August 2015 at Wilson Airport, Nairobi

**Activity 2 — What:** Flight training — 46 hours on Cessna 172 including local and cross-country operations
...
**Tags:** Aerodynamics, Aircraft Systems, Flight Controls, Flight Test, Operations, Regulatory Compliance, Safety, Validation, Verification

**Notes:** Cross-country operations included flights to Malindi area

**Activity 3 — What:** Flight Radio Telephony Operator's Licence — ground examination and certification
...
**Tags:** Aircraft Systems, Communications, Operations, Regulatory Compliance, Validation, Verification

**Notes:** Issued 8th September 2015 by KCAA
